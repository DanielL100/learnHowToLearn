...
- לחיצה על כפתור ההסבר תיתן הסבר על השימוש באתר, אבל לטובת שלמות המסמך ההסבר על האתר נוסף על הוראות השימוש בו יובאו להלן:
  1. כשלב אפס ניתן ללחוץ על כפתור שינוי שם הקורס ולתת את השם הנכון. זה יעזור בעתיד כשהאתר יתמלא בהרבה קורסים לתרגול.
  2. בשלב הראשון יש להוסיף לטבלת ניהול הנושאים את כל הנושאים הרלוונטיים לקורס.
  3. לאחר מכן יש לעבור על כל המבחנים הרלוונטיים שהועלו לתרגול ולהוסיף אותם לטבלה המרכזית. יש למלא את השנה, הסמסטר, המועד ואת נושאי השאלות לבחור מתוך רשימת הנושאים לכל שאלה.
